...
Bei Seanox aspect-js stehen ein minimalistischer Ansatz. Geprägt durch die guten
Erfahrungen aus JSF (Java Server Faces) in Bezug auf Funktion und einfache
Integration ins Markup, entstand der Wunsch nach einer ähnlichen client-seitigen
Lösung als sportliches Experiment um das Verständnis von Rendering, Expression
Language und Performance.
