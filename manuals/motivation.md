...
languages, component structures and the connection between views and models.
These concepts, also present in technologies such as JavaServer Faces (JSF), are
implemented as part of its programming model using native browser technologies.
